    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col justify-center px-8 md:px-16 lg:px-24 py-16">
              ...
              {stages.map((s, i) => (
                ...
                >
                  ...
                  <div className="space-y-3">
                    <div>
                      <p
                        className="text-[#e8e4df]/35 text-xs mb-0.5"
                        style={{ fontFamily: "'Noto Sans SC', sans-serif" }}
                      >
                        节点规模
                      </p>
                    ...
                    >
                      <p
                        className="text-[#e8e4df]/45 text-xs leading-relaxed"
                        style={{ fontFamily: "'Noto Sans SC', sans-serif" }}
                      >
                        {s.milestone}
                      </p>
        ...
        <AnimatedSection animation="fade-in" delay={0.7}>
          <p
            className="text-[#e8e4df]/40 text-sm mt-8 max-w-3xl leading-relaxed"
            style={{ fontFamily: "'Noto Sans SC', sans-serif" }}
          >
