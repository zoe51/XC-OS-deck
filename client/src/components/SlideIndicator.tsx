...
export default function SlideIndicator({ total, active, onNavigate, labels }: SlideIndicatorProps) {
  return (
      ...
      {Array.from({ length: total }).map((_, i) => (
        ...
        >
          <span
            ...
            style={{ fontFamily: "'Noto Sans SC', sans-serif", color: active === i ? '#d4a853' : '#e8e4df' }}
          >
            {labels[i]}
          </span>
          <div
            ...
            style={{
              backgroundColor: active === i ? '#d4a853' : 'rgba(232, 228, 223, 0.3)',
            }}
          />
        </button>
      ))}
